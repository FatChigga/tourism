iv = {
    ...
    bind: function () {
        ...
        $.get(basePath + '/sys/group/groupNodes', null, function (data) {
    ...
    edit: function () {
        ...
        $.post(basePath + 'sys/group/save', JSON.stringify(params), function (data) {
            if (data.result == true) {
        ...
        $.mdlg({
            ...
            onButtonClick: function (sender, modal, index) {
                if (index == 0) {
                    ...
                    $.post(basePath + 'sys/group/delete', JSON.stringify(params), function (data) {
                        if (data.result == true) {
                            $.mdlg.alert('提示', data.message);
                            $('#form-menu').clearForm();
                            iv.bind();
