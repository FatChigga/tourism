iv = {
    ...
    bind: function () {
        var roleSetting = {
            ...
            callback: {
                onClick: function (event, treeId, treeNode) {
                    ...
                    $.get(basePath + '/sys/roleMenu/menuList', {
                        'id': treeNode.id
                    }, function (data) {
        ...
        $.get(basePath + '/sys/roleMenu/roleMenuNodes', null, function (data) {
    ...
    edit: function () {
        ...
        $.post(basePath + 'sys/roleMenu/save', JSON.stringify(params), function (data) {
            if (data.result == true) {
                var treeObj = $.fn.zTree.getZTreeObj("tree-menu");
                var checkedNodes = treeObj.getCheckedNodes();
                $("#btn-save").data("checkedNodes", checkedNodes);
