...
public class SysUserRoleController
    ...
    @RequestMapping(value = {"/userRoleNodes"}, method = {org.springframework.web.bind.annotation.RequestMethod.GET})
    @ResponseBody
    public List userRoleNodes() {
        List data = this.sysUserRoleService.getAllUserRoleForNode();
        return data;
    }

    @RequestMapping(value = {"/roleList"}, method = {org.springframework.web.bind.annotation.RequestMethod.GET})
    @ResponseBody
    public List roleList(@RequestParam Map map) {
        List list = this.sysUserRoleService.roleList(map);
        return list;
    }
    ...
    public Map save(@RequestBody Map map) {
        ...
        Map res = new HashMap();
        try {
            this.sysUserRoleService.doSave(map);
